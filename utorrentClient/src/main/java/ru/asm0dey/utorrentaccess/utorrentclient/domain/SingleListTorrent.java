...
/**
 * Created with IntelliJ IDEA. User: finkel Date: 28.12.12 Time: 13:04 To change this template use File | Settings | File Templates.
 */
public class SingleListTorrent extends ArrayList<String> {
	...
	public enum Status {
		...
		@Override
		public String toString() {
			return ToStringBuilder.reflectionToString( this, ToStringStyle.SHORT_PREFIX_STYLE, false, Object.class );
		}
	}
