...
/**
 * Created with IntelliJ IDEA. User: finkel Date: 28.12.12 Time: 11:15 To change this template use File | Settings | File Templates.
 */
public class TestConnecter {
	...
	public static void main( String[] agrs ) throws IOException, InterruptedException {
		...
		for ( SingleListTorrent singleListTorrent : singleListTorrents ) {
			TorrentFiles filesByTorrentHash = instance.getFilesByTorrentHash( singleListTorrent.getHash() );
